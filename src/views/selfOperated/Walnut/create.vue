<template>
  ...
  <div class="create-wrap w100">
    <div class="btns">
      ...
      <a-button type="primary" @click="handleNext" style="margin-right: 10px"> 回车提交 </a-button>
      ...
      <a-col>
        ...
        <div class="photo">
          <div class="layer-info row cen-center">
            {{ `C${nextData.layer}-${nextData.y}-${nextData.x}` }}
          </div>
        ...
        <a-space>
          <a-input-number size="large" v-model:value="weight" style="margin-top: 40px;" step="0.1" addonAfter="克" />
        </a-space>
      </a-col>
...
const createdWalnut = async () => {
  ...
  if (res.code == '0') {
    ...
    getImgUrl('imageTop', fileList.value)
  ...
  api.createdWalnut({
    batchId: batchId,
    imageTop: getImgUrl('imageTop', fileList.value),
    imageBottom: getImgUrl('imageBottom', fileList.value),
    imageFaceA: getImgUrl('imageFaceA', fileList.value),
    imageFaceB: getImgUrl('imageFaceB', fileList.value),
    imageEdgeA: getImgUrl('imageEdgeA', fileList.value),
    imageEdgeB: getImgUrl('imageEdgeB', fileList.value),
    weight: weight.value,
  }).then(result => {
    if (result.code == '0') {
